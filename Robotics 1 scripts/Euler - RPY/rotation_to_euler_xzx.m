function to_return = rotation_to_euler_xzx(R)
    % rotation_to_euler_xzx: Calcola gli angoli di Euler dalla matrice di rotazione R con configurazione XZX.
    % 
    % Inputs:
    %   R - Matrice di rotazione 3x3
    % 
    % Outputs:
    %   uno, due, tre - Angoli di Euler calcolati dalla matrice di rotazione con configurazione XZX
    ...
    elseif s2 == 0 && c2 > 0
        ...
        disp(['sin(uno + tre) = r32 = ', num2str(R(3,2))]);
